...
static const char *const i18n_en[STR_COUNT] = {
    ...
    [STR_LFS_BLOCKS]            = "Blocks: %d",
    [STR_FROG_ENTRIES]          = "Entries: %d",
    [STR_DETAIL_EMPTY]          = "Empty",
    [STR_DETAIL_FS]             = "Filesystem",
    [STR_DETAIL_ASSETS]         = "Assets",
    [STR_DETAIL_OFW_BACKUP]     = "OFW Backup",
    [STR_DETAIL_APP_BIN]        = "APP BIN",
    [STR_DETAIL_CHAINLOADER]    = "GNW-Chainloader",
    [STR_TYPE_FIRMWARE]         = "Firmware",
